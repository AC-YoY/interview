...
### meta 元素都有什么
```html
<meta> 元素表示那些不能由其它 HTML 元相关（meta-related）元素
...
[GOOGLE SEO 手册](https://developers.google.com/search/docs/beginner/seo-starter-guide?hl=zh-cn)
